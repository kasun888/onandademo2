...
def load_settings():
    default = {
        ...
        "trade_gbpusd":      True,
        "trade_gold":        True,
        "fixed_lot_size":     0.10,    # Fixed 0.10 lots per trade
        "max_consec_losses": 2,
        "max_spread_pips":   2,
...
def calc_position_size(pip_value):
    """
...
def run_bot():
    ...
    for name, config in ASSETS.items():
        ...
        size       = calc_position_size(config["pip"])
